...
const CREDITS = [
    ...
    },
    {
        ...
        rows: [
            ['Mirko K Mohammed', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Mirko K Mohammed', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Mirko K Mohammed'}
        >
            <div
            ...
            >
                <h2>Credits</h2>
                <a href="https://mirkko.dev/">Mirkko.dev, 2023</a>
                <br />
                <br />
                <br />
